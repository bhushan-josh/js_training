...
const filterByName = (str) => Array.filter((obj) => obj.first_name === str )
...
const newEmailArray = Array.map((obj) => obj.email);
...
let newSortedArray = Array.sort(function(obj1, obj2){return (obj2.date_of_birth).localeCompare(obj1.date_of_birth)});
...
const getById = (number) => Array.find((obj) => obj.id === number)
